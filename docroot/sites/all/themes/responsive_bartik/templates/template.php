...
function responsive_green_preprocess_page(&$vars) {
  ...
  $vars['img5'] = base_path() . drupal_get_path('theme', 'responsive_green') . '/images/slide-image-5.jpg';
  $vars['img6'] = base_path() . drupal_get_path('theme', 'responsive_green') . '/images/slide-image-6.jpg';
}
/**
 * Add Google Fonts.
 */
